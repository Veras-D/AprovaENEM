...
## [0.1.1] - 2026-09-18
### 🔧 Changed
- docs(ingestion): Adopt IBM Docling (DocLayNet + TableFormer) as primary Document AI parser over PyMuPDF for two-column flow, native LaTeX formulas, and WebP diagram extraction
