...
| [07-quality-gate-ci.md](file:///home/verivi/Veras/Projects/ReconectaRecode/docs/sprint-1/07-quality-gate-ci.md) | **Automated Quality Gate & CI/CD** | 6-stage GitHub Actions CI workflow with automated quality gates (Checkstyle, PMD, PMD CPD, Trivy, Gitleaks, JaCoCo). |
